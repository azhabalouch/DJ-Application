...
class PitchToggleOffTheme : public LookAndFeel_V4 // Define the PitchToggleOffTheme class, inheriting from LookAndFeel_V4
{
public:
    PitchToggleOffTheme() // Constructor for the PitchToggleOffTheme class
    {
        // Load your image to be displayed on the button here
        image = ImageFileFormat::loadFrom(BinaryData::ToggleOff_png, BinaryData::ToggleOff_pngSize); // Load an image from binary data
